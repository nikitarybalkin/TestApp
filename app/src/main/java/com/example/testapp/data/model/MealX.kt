...
data class MealX(
    ...
    @Json(name = "strIngredient16")val strIngredient16: Any,
    @Json(name = "strIngredient17")val strIngredient17: Any,
    @Json(name = "strIngredient18")val strIngredient18: Any,
    @Json(name = "strIngredient19")val strIngredient19: Any,
    @Json(name = "strIngredient2")val strIngredient2: String,
    @Json(name = "strIngredient20")val strIngredient20: Any,
    ...
    @Json(name = "strMeasure16")val strMeasure16: Any,
    @Json(name = "strMeasure17")val strMeasure17: Any,
    @Json(name = "strMeasure18")val strMeasure18: Any,
    @Json(name = "strMeasure19")val strMeasure19: Any,
    @Json(name = "strMeasure2")val strMeasure2: String,
    @Json(name = "strMeasure20")val strMeasure20: Any,
    ...
    @Json(name = "strSource")val strSource: Any,
